 ...
 * if/ifdef/ifndef directive whose condition does not evaluate to true.
 */
CINDEX_LINKAGE CXSourceRangeList* clang_getAllSkippedRanges(
 ...
 */
CINDEX_LINKAGE enum CXDiagnosticSeverity clang_getDiagnosticSeverity(
    CXDiagnostic);
...
CINDEX_LINKAGE enum CXErrorCode clang_createTranslationUnit2(
    CXIndex CIdx, const char* ast_filename, CXTranslationUnit* out_TU);
 ...
 */
CINDEX_LINKAGE int clang_reparseTranslationUnit(
    CXTranslationUnit TU, unsigned num_unsaved_files,
    struct CXUnsavedFile* unsaved_files, unsigned options);
 ...
 */
CINDEX_LINKAGE enum CXAvailabilityKind clang_getCursorAvailability(
    CXCursor cursor);
 ...
 */
CINDEX_LINKAGE void clang_disposeCXPlatformAvailability(
...
/**
 * \brief Represents the storage classes as declared in the source.
 * CX_SC_Invalid
 ...
 */
CINDEX_LINKAGE unsigned clang_visitChildrenWithBlock(
 ...
 */
CINDEX_LINKAGE unsigned clang_Cursor_getObjCPropertyAttributes(
    CXCursor C, unsigned reserved);
...
/**
 * \brief Given a CXCursor_ModuleImportDecl cursor, return the associated
 * module.
 */
 ...
 */
CINDEX_LINKAGE unsigned clang_CXXConstructor_isConvertingConstructor(
    CXCursor C);
 ...
 */
CINDEX_LINKAGE unsigned clang_getNumCompletionChunks(
 ...
 */
CINDEX_LINKAGE unsigned clang_getCompletionPriority(
    CXCompletionString completion_string);
 ...
 */
CINDEX_LINKAGE enum CXAvailabilityKind clang_getCompletionAvailability(
    CXCompletionString completion_string);
 ...
 * string.
 */
CINDEX_LINKAGE unsigned clang_getCompletionNumAnnotations(
    CXCompletionString completion_string);
...
CXCodeCompleteResults* clang_codeCompleteAt(
    CXTranslationUnit TU, const char* complete_filename, unsigned complete_line,
...
enum CXCursorKind clang_codeCompleteGetContainerKind(
    CXCodeCompleteResults* Results, unsigned* IsIncomplete);
...
typedef struct { CXCursor cursor; } CXIdxContainerInfo;
...
CINDEX_LINKAGE const CXIdxCXXClassDeclInfo* clang_index_getCXXClassDeclInfo(
    const CXIdxDeclInfo*);
